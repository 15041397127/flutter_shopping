class DetailsModel {
  ...
  DetailsModel.fromJson(Map<String, dynamic> json) {
    ...
    data = json['data'] != null ? new DetailsGoodsModel.fromJson(json['data']) : null;
  }
...
class DetailsGoodsModel {
  ...
  DetailsGoodsModel({this.goodInfo, this.goodComments, this.advertesPicture});
